...
Record the walkthrough yourself (8–12 min): admin paper + assign, candidate attempt with a tab switch, submit, admin timeline, mention timer/autosave and the 403 on another user's attempt. Swagger screenshot doesn't hurt.
